...
@section('title', 'Add New Custom Order')
            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header bg-warning">
                        <h4 class="mb-0"><i class="fas fa-plus me-2"></i>Add New Custom Order</h4>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('admin.custom-orders.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('order_name') is-invalid @enderror"
                                    id="order_name" name="order_name" value="{{ old('order_name') }}" required>
                                @error('order_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="not_made" {{ old('status') == 'not_made' ? 'selected' : '' }}>Not Made</option>
