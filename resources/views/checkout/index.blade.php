                        ...
                        <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                            ...
                            <div class="text-end">
                                <strong class="text-success">
                                    Rp {{ number_format($item->product->getDiscountedPrice() * $item->quantity, 0, ',', '.') }}
                                </strong>
                            </div>
                        </div>
                    @endforeach
...
document.getElementById('province').addEventListener('change', async function() {
    ...
    document.getElementById('courier-options').innerHTML = '<div class="alert alert-info">Please select district first</div>';
...
function displayCourierOptions(costs) {
    ...
    let html = '<label class="form-label fw-bold">Select Courier <span class="text-danger">*</span></label><div class="list-group">';
    ...
    console.log(`✅ Displayed ${costs.length} courier options`);
}
...
function updateShippingCost(cost, code, service) {
    ...
    console.log('✅ Shipping updated:', { code, service, cost, total });
}
</script>
@endpush